...
%% Draw Patch Object
CuboidHandle = patch('Faces',facs1,'Vertices',verts','FaceColor',colr,'FaceAlpha',alph);
% CuboidHandle2 = patch('Faces',facs2,'Vertices',verts(:,1:4)','FaceColor',[1,0,0],'FaceAlpha',alph);
